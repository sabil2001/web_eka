            ...
            <div class="card">
                <div class="card-body">
                    <div class="row mt-4">
                        ...
                        <div class="col p-2">
                            <div class="border border-danger rounded text-danger text-deadline"><span class="">Status: {{ $produksi->keranjang->status }}</span></div>
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-6">
                    ...
                    @if ($produksi->keranjang->status == 'Belum diproduksi')
                    <div class="row mt-4 bg-light p-2 rounded">
                        ...
                        <div class="col d-flex">
                            <div class="justify-content-center align-self-center mx-auto">
                                ...
                                <a href="/dashboard/order/edit/{{ $produksi->keranjang->id }}" class="button-show-edit" style="width: 220px"><i class="bi bi-pencil-square"></i><span class="ms-2">EDIT</span></a>
                                ...
                                <form action="/dashboard/order/batal/{{ $produksi->keranjang->id }}" method="post" id="batal" class="mt-2">
                                    @method('put')
                                    @csrf
