           ...
           <div class="card-body">
              <div class="tab-content">
                 <div class="tab-pane fade show active profile-overview" id="profile-overview"> 
                    ...
                    @endforeach
                    <div class="row mt-2">
                        <form method="post" action="/dashboard/pesanan/saveeditverifikasi/{{ $produksi->id }}">
                        @method('put')  
                        @csrf
                        <div class="col-4">
                        ...
                        <div class="col mt-2">
                            ...
                            <select class="form-select" aria-label="status_verifikasi" id="status_verifikasi" name="status_verifikasi" placeholder="status_verifikasi" required value="{{ old('status_verifikasi') }}">
                                ...
                                <option value="Verifikasi" class="bg-success text-white">Verifikasi</option>
                                <option value="Revisi" class="bg-danger text-white">Revisi</option>
