                    ...
                    <div class="row mt-4 bg-light p-2 rounded">
                        <div class="col-8 col-md-6">
                            <div class="text-muted text-secondary small">
                                ...
                                <li>Aksi yang dilakukan selanjutnya:
                                  <ul>
                                        <li>Periksa kembali pesanan dan hasil produksi</li>
                                        <li>Jika sudah selesai, klik tombol Selesai untuk Verifikasi produksi</li>
                                        <li>Jika ada yang tidak sesuai, ceklis Revisi dan isi keterangan kemudian klik tombol Simpan</li>
                                  </ul>
                                </li>
                              </ul>
                            </div>
                        ...
                        <div class="col d-flex">
                            <div class="justify-content-center align-self-center mx-auto">
                                <form action="/dashboard/verifikasi/selesai/{{ $produksi->keranjang->id }}" method="post">
                                    @csrf
                                    <button class="button-produksi" style="width: 220px"><i class="bi bi-save2"></i><span class="ms-2">VERIFIKASI</span></button>
                                    <input type="hidden" value="{{ $produksi->id }}" name="produksi_id">
                                    {{-- <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="button_batal" value="Revisi" name="revisi">
                                        <label class="form-check-label" for="flexCheckDefault">
                                          Revisi
                                        </label>
                                    </div>
                                    <div class="mb-3" id="keterangan-form">
