...
<section class="section">
  <div class="row">
     <div class="col-lg-12">
        <div class="card">
           <div class="card-body">
              <h5 class="card-title">Data Proses Produksi</h5>
              <hr>
                  ...
                  <tbody>
                    @foreach ($produksis as $produksi)
                        <tr>
                          ...
                          <td>{{ Carbon\Carbon::parse($produksi->keranjang->tgl_jatuh_tempo)->diffInDays(Carbon\Carbon::now()) }} Hari</td>
                          {{-- <td>{{ $produksi->user->name }}</td> --}}
                          <td>
                              <span class="badge bg-info">{{ $produksi->status }}</span>
                          </td>
                          ...
                          <td class="text-center">
                            <a href="/dashboard/keranjang/produksi/prosesselesai/{{ $produksi->id }}" title="Selesai Produksi {{ $produksi->keranjang->kode_keranjang }}" class="tombol-aksi text-center"><i class="bi bi-check-circle"></i> Selesaikan Produksi</a>
                          </td>
                        </tr>
                    @endforeach
                  </tbody>
