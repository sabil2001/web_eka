...
<section class="section">
  <div class="row">
     <div class="col-lg-12">
        <div class="card">
           <div class="card-body">
              <h5 class="card-title">Data Selesai Produksi</h5>
              <hr>
                  ...
                  <tbody>
                    @foreach ($produksis as $produksi)
                        <tr>
                          ...
                          <td class="text-center">
                            <a href="/dashboard/barang/selesai/detail/{{ $produksi->id }}" title="Detail {{ $produksi->keranjang->kode_keranjang }}" class="tombol-aksi text-center"><i class="bi bi-list-ol"></i> Detail</a>
                          </td>
                        </tr>
                    @endforeach
                  </tbody>
